...
const ICON_SIZE = Spacing['3xl'] + Spacing.lg;
const BUTTON_MAX_WIDTH = Spacing['3xl'] * 7 + Spacing.lg;
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.content}>
        <IconSymbol name="music.note" size={ICON_SIZE} color={Colors.textSecondary} />
